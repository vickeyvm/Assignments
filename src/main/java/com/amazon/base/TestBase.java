...
public class TestBase {
	...
	public TestBase() {
		...
		try {
		prop = new Properties();
		FileInputStream ip = new FileInputStream("/home/vickey.manwar/Desktop/NoytAssignment/src/main/java/com/amazon/config/config.properties");
	...
	public static void initialization() {
		...
		if(browserName.equals("chrome")) {
			System.setProperty("webdriver.chrome.driver", "/home/vickey.manwar/Desktop/NoytAssignment/src/main/resources/chromedriver");
